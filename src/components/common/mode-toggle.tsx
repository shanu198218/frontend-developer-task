  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button data-cy="mode-toggle-button" variant="outline" size="icon">
      ...
      >
        ...
        <DropdownMenuItem
          data-cy="mode-option-dark"
          className="
            my-1 border-0 hover:border-0 hover:border-transparent
            focus:border-0 focus:outline-none focus-visible:ring-0
            data-[highlighted]:outline-none data-[highlighted]:ring-0
            focus:bg-slate-100 w-24 text-center rounded-md dark:focus:bg-white/5
          "
