...
export default function BorrowerItem({ borrower }: { borrower: Borrower }) {
  ...
  <div className="w-64 flex-initial"><div className="min-w-0">
  ...
  <div className="w-32 flex-initial"> <div className="text-right font-semibold text-white whitespace-nowrap">
        {borrower.amount}
      </div></div>
</div>
